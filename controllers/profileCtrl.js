...
module.exports = {
   getFriends: function(req, res, next) {
      res.send({currentUser: req.session.currentUser,   //step 13: this function sends back the currentUser
            friends: profiles});                        //object (that has the user info and sesion id) and the friend profiles
         }                                              //req.session.currentUser is saved from userCtrl.js in an express header, that's how we ahve access here
}                                                       //GO TO: index.js
